// Pg -22
//./4_gamma_opt_tbb_flowgraph_pipelined
// Time : 1.11107 seconds   ( Debug build )             TBB peformance lower than baseline
//./3_gamma_baseline 
// Time : 0.138515 seconds  ( Release build )           TBB peformance higher than baseline
#include <iostream>
#include <vector>
#include <tbb/tbb.h>
#include "intro_example.hpp"
